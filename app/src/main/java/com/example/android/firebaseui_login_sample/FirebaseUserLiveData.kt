...
class FirebaseUserLiveData : LiveData<FirebaseUser?>() {
    ...
    // TO DO set the value of this FireUserLiveData object by hooking it up to equal the value of the
    ...
    private val authStateListener = FirebaseAuth.AuthStateListener { firebaseAuth ->
        // TO DO Use the FirebaseAuth instance instantiated at the beginning of the class to get an
